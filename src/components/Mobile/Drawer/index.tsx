...
export default function Drawer({ className, open, action }: IDrawer) {
        ...
        >
            ...
            <div className="flex justify-between items-center">
              <div className="flex space-x-5 items-center">
                <div className="compaire relative">
                  ...
                  <span className="w-[18px] h-[18px] rounded-full bg-blue-500 text-white absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px]">
                    2
                  </span>
                </div>
                {isLoggedIn ? (
          ...
          <div className="w-full mt-5 px-5">
            <div className="search-bar w-full h-[34px]  flex ">
              ...
              <div className="w-[40px] h-full bg-blue-500 flex justify-center items-center">
                <span>
                  <svg
                    width="23"
                    height="23"
            ...
            <div className="category-item mt-5 w-full">
              <ul className="categories-list">
                <li className="category-item">
                  <a href="/all-products">
                    <div className=" flex justify-between items-center px-5 h-12 bg-white hover:bg-blue-500 transition-all duration-300 ease-in-out cursor-pointer">
                ...
                <li className="category-item">
                  <a href="/all-products">
                    <div className="flex justify-between items-center px-5 h-12 bg-white hover:bg-blue-500 transition-all duration-300 ease-in-out cursor-pointer">
                      <div className="flex items-center space-x-6">
                        <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="15" rx="2" ry="2"></rect><polyline points="17 2 12 7 7 2"></polyline></svg>
                        </span>
                        <span className="text-sm font-400">Electronics</span>
                      </div>
                      <div>
                        <span>
                          <svg
