...
export default function Dashboard({ orders }: { orders: IOrder[] }) {
  ...
  return (
    <>
      <div className="welcome-msg w-full">
        <div>
          <p className="text-qblack text-lg">Hello, {user?.firstname}</p>
      ...
      <div className="dashboard-info mt-8 flex justify-between items-center bg-primarygray px-7 py-7">
        ...
        <div
          className="w-[1px] h-[164px] bg-[#E4E4E4]"
          style={{ opacity: '0' }}
        ></div>
        <div className="ml-6" style={{ opacity: '0' }}>
