...
export default function ProfileTab() {
  ...
  const { fields, submit, submitting, reset, dirty } = useForm({
    fields: {
      firstname: useField({
    ...
    <>
        ...
        <div className="w-[570px] ">
          ...
          <div className="input-item flex space-x-2.5 mb-8">
            ...
            <div className="w-1/2 h-full">
              ...
              >
                {fields.phone.error && (
                  <span style={{ color: 'red' }}>{fields.phone.error}</span>
                )}
              </InputCom>
            </div>
          </div>
            ...
            <div className="w-full">
              ...
              >
                {fields.address.error && (
                  <span style={{ color: 'red' }}>{fields.address.error}</span>
                )}
              </InputCom>
            </div>
          </div>
      ...
      <div className="action-area flex space-x-4 items-center">
        ...
        <button
          ...
          disabled={hasValidationError || submitting || !dirty}
          onClick={() => {
            submit();
          }}
        >
